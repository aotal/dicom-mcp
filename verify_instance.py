import logging
from src.dicom_mcp.dicom_client import DicomClient
from src.dicom_mcp.config import load_config

# Suppress pynetdicom logging for cleaner output
logging.getLogger('pynetdicom').setLevel(logging.CRITICAL)

try:
    config = load_config('C:/Users/25166122M/dicom/mcp/dicom-mcp/src/dicom_mcp/configuration.yaml')
    client = DicomClient(
    ...
    result = client.query_instance(
        series_instance_uid='1.3.46.670589.30.41.0.1.128635482625724.1743412778135.1',
        sop_instance_uid='1.3.46.670589.30.41.0.1.128635482625724.1743414241784.1'
    )
    print(result)
